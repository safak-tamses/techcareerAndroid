...
public class VeriTabaniYemek implements Serializable {
    private String yemek_id;
    private String yemek_adi;
    private String yemek_resim_adi;
    private int yemek_fiyat;

    public VeriTabaniYemek() {
    }

    public VeriTabaniYemek(String yemek_id, String yemek_adi, String yemek_resim_adi, int yemek_fiyat) {
